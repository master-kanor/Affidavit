...
import { DocumentPreviewModal, PreviewDocument } from "./DocumentPreviewModal";
              ...
              <div className="grid gap-2">
                {section.documents.map((doc) => (
                  <button
                    ...
                    className="w-full text-left flex items-center gap-3 p-3 bg-gray-50 hover:bg-blue-50/50 rounded-lg transition-colors border border-gray-200 hover:border-blue-300 group cursor-pointer"
                  >
                    <FileText className="w-4 h-4 text-gray-600 group-hover:text-blue-600 flex-shrink-0 transition-colors" />
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-gray-900 group-hover:text-blue-900 truncate transition-colors">
                        {doc.title}
                      </p>
                      <p className="text-xs text-gray-600">{doc.type}</p>
                    </div>
                    <span className="text-xs text-blue-600 font-medium flex-shrink-0 bg-blue-50 group-hover:bg-blue-100 px-2 py-1 rounded transition-colors">
                      Preview In-Page
                    </span>
                  </button>
                ))}
      ...
      <div className="bg-gray-50 border-t border-gray-200 px-6 py-8">
        <div className="max-w-4xl mx-auto text-center text-gray-600 text-sm">
          ...
          <p className="mt-2 text-xs text-gray-500">
            Tacloban City, Leyte, 6500 • Generated on {new Date().toLocaleDateString()}
          </p>
        </div>
      </div>
    </div>
